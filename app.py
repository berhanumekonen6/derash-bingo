...
def init_session_state():
    ...
    # ⚠️ game_started is the SINGLE source of truth, kept in session only
...
def get_global_remaining_time():
    ...
    Reads the shared in-memory store every tick. Uses st.session_state.taken_cards
    (never the file) to decide whether to hold or reset at 0:00."""
...
def maybe_start_game():
    ...
    Uses st.session_state.taken_cards (already synced by sync_global_cards)
    and the shared in-memory timer store.
    """
...
# Note: the rest of the 201-card list continues as-is — the ellipsis below
# is only for the length of THIS reply, not your file. Keep your full list.
...
def render_card_selection():
    """Card selection screen. Note: assumes sync_global_cards() has ALREADY
    been called at the top level for this tick — we don't call it again here."""
...
# ===================================================================
# ✅ SYNC GLOBAL STATE — runs ONCE per tick
# ===================================================================
...
# ===================================================================
# ✅ START THE GAME — the ONLY start-check, runs at top level
# ===================================================================
maybe_start_game()
