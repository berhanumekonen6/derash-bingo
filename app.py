...
def sync_global_winners():
    ...
    if winner_declared:
        ...
        st.session_state.called_numbers = called_numbers if called_numbers else st.session_state.called_numbers
        st.session_state.last_called_number = last_called_number if last_called_number else st.session_state.last_called_number
        st.session_state.auto_called_count = auto_called_count if auto_called_count > 0 else st.session_state.auto_called_count
    ...
    for i in range(1, 202):
        ...
        with cols[col_idx]:
            ...
            if is_clicked:
                ...
                # Card is taken by someone else - DISABLED
                btn_type = "secondary"
                label = str(i)
...
if st.session_state.game_started:
    ...
    if st.session_state.winner_declared:
        ...
        # Display ONLY winner cards (not all cards)
        if st.session_state.winners_list:
            # Display winner cards in a grid (3 columns)
